...
class Listify_Results {
	...
	public static function register_scripts() {
		...
		// Google Maps.
		wp_register_script( 'google-maps', listify_get_google_maps_api_url(), array(), '3.33', true );
		...
		// Leaflet.
		wp_register_script( 'leaflet', '//api.mapbox.com/mapbox.js/v3.1.1/mapbox.js', array(), '3.1.1', true );
		wp_register_style( 'leaflet', '//api.mapbox.com/mapbox.js/v3.1.1/mapbox.css', array(), '3.1.1' );
		...
		if ( 'col-12 col-md-6' === $class_column ) {
			$columns = '2';
		} elseif ( 'col-12 col-md-6 col-lg-4' === $class_column ) {
			$columns = '3';
		}
		...
		$settings = array(
			...
			'mapService'        => apply_filters(
				'listify_map_service_settings',
				array(
					'service'     => get_theme_mod( 'map-service-provider', 'googlemaps' ),
					'center'      => array_map( 'floatval', explode( ',', listify_sanitize_coordinate( get_theme_mod( 'map-behavior-center', '' ) ) ) ),

...
class Listify_WP_Job_Manager extends listify_Integration {
	...
	public function setup_actions() {
		add_filter( 'job_manager_show_admin_notice_core_setup', '__return_false' );
		...
		// Make sure archives know about the shorcode.
		add_filter( 'has_wpjm_shortcode', '__return_true' );
		add_filter( 'job_manager_enhanced_select_enabled', '__return_true' );
	}
